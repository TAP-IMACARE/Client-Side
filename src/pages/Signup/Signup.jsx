    ...
    return <div className="signup-container">
        ...
        <div className="signup-form">
            ...
            <form>
                ...
                <label>Email Address</label>
                    <div className="signup-input-with-icon">
                          <img src={SignupMailImage} alt="Icon" className="signup-icon2" value={email} onChange={handleEmailChange} />
                    ...
                    <div className="signup-form-group">
                      ...
                      <div className="signup-input-with-icon">
                          <span className="signup-icon2"><img src={SignupLockImg} alt="Icon" /></span>
                          <input type="text" placeholder="Enter your password" id="signup-unique-form" value={password} onChange={handlePasswordChange}/>
                  ...
                  <p id="signup-terms">By signing you agree to our <span>Terms of use</span> and <span>Privacy Policy</span></p>
        ...
        <img src={SignupImaImg} alt="ImaCare" />
              <div className="login-copyright">
                  <h1>Access quality medical care, therapy & support for you and your family</h1>
